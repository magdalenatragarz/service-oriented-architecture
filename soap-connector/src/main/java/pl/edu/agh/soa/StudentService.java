...
public interface StudentService {
    ...
    @WebMethod
    @RequestWrapper(localName = "erase", targetNamespace = "http://soa.agh.edu.pl/", className = "pl.edu.agh.soa.Erase")
    @ResponseWrapper(localName = "eraseResponse", targetNamespace = "http://soa.agh.edu.pl/", className = "pl.edu.agh.soa.EraseResponse")
    public void erase();
